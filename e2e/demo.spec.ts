...
test.describe('Demo mode', () => {
	test('loads trips and shows the summary controls without console errors', async ({ page }) => {
		const errors: string[] = [];
		...
		// Compteurs alimentés par les données démo (137 trajets dans le jeu fourni)
